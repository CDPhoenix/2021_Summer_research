# -*- coding: utf-8 -*-
"""
Created on Sat Aug  7 19:41:38 2021
...
dataset_path1 = 'D:/Python/exp_data1.csv'
column_names1 = ['KP','KP_1','ETA','rr','path_length']
raw_dataset1 = pd.read_csv(dataset_path1, names=column_names1,na_values = "?", comment='\t' ,
                           sep = ",", skipinitialspace=True)

train_datasets = raw_dataset1.copy()
train_datasets = train_datasets.dropna()
train_datas = train_datasets.sample(frac=0.8,random_state=0)
test_datas = train_datasets.drop(train_datas.index)
...
def build_model():
    model = keras.Sequential([
        layers.Dense(40,activation='relu',input_shape=[len(train_datas.keys())]),
...
plt.xlabel("Prediction Error [path_length]")
_ = plt.ylabel("Count")
plt.show()